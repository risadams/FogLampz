...
namespace FogLampz.Model
{
  ...
  public partial class Case : FogBugzEntityBase
  {
	...
	public string PriorityName {get;set;}
		[PropertyMap("hrsOrigEst", ConversionStrategy.Integer)]
	public int? HoursOriginalEstimate {get;set;}
		[PropertyMap("hrsCurrEst", ConversionStrategy.Integer)]
	public int? HoursCurrentEstimate {get;set;}
		[PropertyMap("hrsElapsed", ConversionStrategy.Integer)]
